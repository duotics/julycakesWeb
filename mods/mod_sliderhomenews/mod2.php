...
$query_RSa0 = sprintf("SELECT * FROM tbl_articles WHERE art_id = %s ORDER BY art_id DESC LIMIT 1",
GetSQLValueString("85", "int"));
...
<div id="myCarousel2" class="carousel slide carousel-home" data-ride="carousel">
	...
	<div class="carousel-inner text-center">
        ...
        <a href="<?php echo $RAIZ ?>a/<?php echo $row_RSa0['art_url'] ?>">
